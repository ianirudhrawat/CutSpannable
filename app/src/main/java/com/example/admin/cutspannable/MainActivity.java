    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b=findViewById(R.id.button1);
         ...
         final SpannableStringBuilder s=new SpannableStringBuilder("Bee-keepers and those interested in taking up apiculture can learn more as the city's first Honey and Organic Mela will be conducted at the Kadri Park here for two days from Saturday.\n" +
                 ...
                 "Addressing media here on Thursday, she said that the mela would display varieties of honey produced depending on seasons. Honey's quality differed based on the flowering seasons. The mela would also display by-products of honey.\n" +
                 "She said that as honey was being used for medicinal purpose, its medicinal values would be highlighted at the mela. The exhibition would be open from 10 a.m. to 8 p.m. The entry will be free. The mela would also have a seminar-cum-training session on Sunday at 10 a.m.\n" +
